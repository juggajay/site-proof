...
This command **requires** the project directory as an argument via `D:\site-proofv3`.

**Example:** `/create-spec generations/my-app`

**Output location:** `D:\site-proofv3/prompts/app_spec.txt` and `D:\site-proofv3/prompts/initializer_prompt.md`

If `D:\site-proofv3` is empty, inform the user they must provide a project path and exit.
...
The output directory is: `D:\site-proofv3/prompts/`

Once the user approves, generate these files:

## 1. Generate `app_spec.txt`

**Output path:** `D:\site-proofv3/prompts/app_spec.txt`
...
**Output path:** `D:\site-proofv3/prompts/initializer_prompt.md`
...
**Output path:** `D:\site-proofv3/prompts/.spec_status.json`
...
> "Your specification files have been created in `D:\site-proofv3/prompts/`!
>
> **Files created:**
> - `D:\site-proofv3/prompts/app_spec.txt`
> - `D:\site-proofv3/prompts/initializer_prompt.md`
>
