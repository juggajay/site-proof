...
- Answer exact page, control, indicator, role, and behaviour questions with search_ui_knowledge; call get_page_guide on its best route when the full control guide is needed.
