...
router.get('/:projectId/weather/:date', asyncHandler(async (req: Request, res: Response) => {
...
router.get('/project/:projectId/delays', asyncHandler(async (req: Request, res: Response) => {
...
router.get('/project/:projectId/delays/export', asyncHandler(async (req: Request, res: Response) => {
...
router.get('/project/:projectId/docket-summary/:date', asyncHandler(async (req: Request, res: Response) => {
...
router.get('/:diaryId/timeline', asyncHandler(async (req: Request, res: Response) => {
