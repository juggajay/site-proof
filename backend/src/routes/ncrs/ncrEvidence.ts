...
ncrEvidenceRouter.post('/:id/evidence', requireAuth, asyncHandler(async (req: any, res) => {
...
ncrEvidenceRouter.get('/:id/evidence', requireAuth, asyncHandler(async (req: any, res) => {
  const user = req.user as AuthUser
  const { id } = req.params
...
ncrEvidenceRouter.delete('/:id/evidence/:evidenceId', requireAuth, asyncHandler(async (req: any, res) => {
  const user = req.user as AuthUser
