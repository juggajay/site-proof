...
ncrCoreRouter.get('/', requireAuth, async (req: any, res) => {
  try {
...
ncrCoreRouter.get('/:id', requireAuth, async (req: any, res) => {
  try {
    const user = req.user as AuthUser
    const { id } = req.params
...
ncrCoreRouter.post('/', requireAuth, async (req: any, res) => {
  try {
...
ncrCoreRouter.patch('/:id', requireAuth, async (req: any, res) => {
  try {
