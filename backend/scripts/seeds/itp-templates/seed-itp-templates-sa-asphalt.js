 ...
 *            Stone Mastic Asphalt (RD-BP-S2/C3), Warm Mix / Recycled Asphalt (RD-BP-S2)
 *
 * Sprayed bituminous surfacing (RD-BP-D2) lives in its own seeder,
 * seed-itp-templates-sa-seals.js (activity 'seals').
 *
...
// =============================================================================
// TEMPLATE 4: WARM MIX / RECYCLED ASPHALT (DIT RD-BP-S2)
// DIT RD-BP-S2 Supply of Asphalt (supersedes Part R27)
...
async function main() {
  ...
  try {
    ...
    console.log('\n═══════════════════════════════════════════════════════════════')
    console.log(' Seeding Complete! (4 asphalt templates)')
    console.log('═══════════════════════════════════════════════════════════════')
  } catch (error) {
