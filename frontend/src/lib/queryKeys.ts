...
export const queryKeys = {
  ...
  lotSurveys: (lotId: string) => ['lot-surveys', lotId] as const,
  lotDeliveries: (lotId: string) => ['lot-deliveries', lotId] as const,
  ...
  orthoLayers: (projectId: string) => ['ortho-layers', projectId] as const,
