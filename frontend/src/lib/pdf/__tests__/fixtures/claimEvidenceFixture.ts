          ...
          decisionRounds: [
            {
              id: 'round-claim-1',
              roundNumber: 1,
              requestedAt: '2026-05-18T22:00:00.000Z',
              responseToPriorRejection: null,
              outcome: 'rejected',
              decidedAt: '2026-05-19T01:00:00.000Z',
              decidedByName: 'Alex Client',
              decidedByOrg: 'Transport for NSW',
              decisionReason: 'Soft spot remained at chainage 220.',
              withdrawnAt: null,
            ...
            },
            {
              ...
              responseToPriorRejection: 'Soft spot was undercut and recompacted.',
              outcome: 'released_with_conditions',
              decidedAt: '2026-05-20T04:00:00.000Z',
              decidedByName: 'Sam Supervisor',
              decidedByOrg: 'Client Superintendent Org',
              decisionReason: 'Permission to proceed subject to survey lodgement.',
              withdrawnAt: null,
              withdrawalReason: null,
              conditions: [
                {
                  id: 'condition-claim-1',
                  sequence: 1,
                  text: 'Lodge the final survey.',
                  recordedSatisfiedAt: '2026-05-20T05:00:00.000Z',
                  recordedSatisfiedByName: 'Jordan Surveyor',
                  satisfactionNote: 'Survey lodged.',
                  satisfactionEvidenceDocumentId: 'doc-survey-claim',
                },
                {
                  id: 'condition-claim-2',
                  sequence: 2,
                  text: 'Submit the compaction retest.',
