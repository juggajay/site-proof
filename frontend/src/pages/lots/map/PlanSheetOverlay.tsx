 ...
 * the image, then places it via the rotated ImageOverlay. Renders nothing until
 * the image is ready or if the sheet lacks registration corners.
 */
export function PlanSheetOverlay({ projectId, sheet, opacity }: PlanSheetOverlayProps) {
  const { url } = usePlanOverlayImage(projectId, sheet);
