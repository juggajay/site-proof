    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        ...
        <div className="flex gap-3">
          <button
            ...
            className="px-4 py-2 border border-primary text-primary rounded-md hover:bg-primary/5 flex items-center gap-2"
          >
      ...
      {loading ? (
        ...
        <>
          ...
          <div className="hidden print:block report-header mb-6">
            <div className="flex items-center justify-between border-b-2 border-foreground pb-4">
              ...
              <div className="text-right flex items-center gap-3">
                ...
                <div>
                  <div className="text-xl font-semibold text-primary">{companyName || 'SiteProof'}</div>
          ...
          {/* Tab Content */}
          <Suspense fallback={<div className="flex items-center justify-center py-12"><div className="text-muted-foreground">Loading tab...</div></div>}>
