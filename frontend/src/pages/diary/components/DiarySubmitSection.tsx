    ...
    try {
      ...
      const pdfData: DailyDiaryPDFData = {
        ...
        personnel: diary.personnel.map((p) => ({
          ...
          hours: p.hours,
          source: p.source,
          lot: p.lot ? { lotNumber: p.lot.lotNumber } : null,
        })),
        ...
        delays: diary.delays.map((d) => ({
          ...
          impact: d.impact,
          lot: d.lot ? { lotNumber: d.lot.lotNumber } : null,
        })),
        deliveries: (diary.deliveries ?? []).map((d) => ({
          id: d.id,
          description: d.description,
          supplier: d.supplier,
        ...
        events: (diary.events ?? []).map((e) => ({
          ...
          lot: e.lot ? { lotNumber: e.lot.lotNumber } : null,
        })),
        visitors: (diary.visitors ?? []).map((v) => ({
          id: v.id,
          name: v.name,
          company: v.company,
          purpose: v.purpose,
          timeInOut: v.timeInOut,
        })),
