    ...
    return (
      <div className="space-y-4 text-center">
        ...
        <p className="text-muted-foreground">
          We've sent a magic link to <strong>{magicLinkEmail}</strong>. Click the link in the email
          to sign in.
        </p>
        <p className="text-sm text-muted-foreground">The link will expire in 15 minutes.</p>
        <Button
          variant="link"
          onClick={() => {
      ...
      <form onSubmit={magicLinkForm.handleSubmit(onMagicLinkSubmit)} className="space-y-4">
        ...
        <div>
          ...
          <Input
            ...
            className={`mt-1 ${magicLinkForm.formState.errors.email ? 'border-destructive' : ''}`}
          />
  ...
  if (mfaRequired) {
    ...
    return (
      <form onSubmit={mfaForm.handleSubmit(onMfaSubmit)} className="space-y-4">
        ...
        <Button type="submit" disabled={loading || !canSubmitMfa} className="w-full">
