...
export function buildNcrDetailPdfData(ncr: NCR): NCRDetailData {
  return {
    ncr: {
      ...
      status: ncr.status,
      specificationReference: ncr.specificationReference,
      ...
      concessionJustification: ncr.concessionJustification,
      concessionRiskAssessment: ncr.concessionRiskAssessment,
      clientApprovalReference: ncr.clientApprovalReference,
