...
export function LinearMapView({ lots, onLotClick, areas = [] }: LinearMapViewProps) {
  ...
  const chainageToX = (chainage: number) => {
    return getChainageX(chainage, minChainage, totalRange, zoomLevel, panOffset);
  };
            ...
            >
              ...
              <div className="flex-1 relative" data-testid={`layer-content-${layerName}`}>
                ...
                {areas
                  .filter(
                    (area) =>
                      area.chainageStart !== null && area.chainageEnd !== null && area.colour,
                  )
                  .map((area) => {
            ...
            {areas
              ...
              .map((area) => (
                <div
                  ...
                  data-testid={`area-legend-${area.id}`}
                >
                  <div
            ...
            <div className="space-y-1 text-sm mb-4">
              <div className="flex justify-between">
                ...
                <span className="font-medium">
                  {(popup.lot.chainageStart ?? 0).toLocaleString()} -{' '}
                  {(popup.lot.chainageEnd ?? 0).toLocaleString()}
                </span>
              </div>
              <div className="flex justify-between">
