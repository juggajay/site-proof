...
import { ChevronDown, FolderKanban, Search, Sparkles } from 'lucide-react';
  ...
  return (
    <header className="flex h-16 items-center justify-between border-b bg-card px-6">
      ...
      <div className="flex items-center gap-2">
        ...
        {/* Notification bell — badge plus the triaged dropdown. The badge and
            its icon anchoring moved into the component unchanged. */}
        <NotificationBell />
