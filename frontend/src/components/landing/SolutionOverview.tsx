      ...
      <div className="container mx-auto px-4 md:px-6">
        ...
        <StaggerContainer className="grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
          {features.map((feature, index) => (
            <FadeIn key={index}>
              <div className="group flex items-start space-x-4 p-6 rounded-xl bg-card border border-border shadow-sm transition-all duration-300 hover:shadow-xl hover:-translate-y-1 hover:border-primary/20">
                <div className="flex-shrink-0">
                  <div className="flex items-center justify-center h-12 w-12 rounded-lg bg-primary text-white transition-transform group-hover:scale-110 group-hover:rotate-3">
