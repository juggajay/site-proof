      ...
      <div className="container mx-auto px-4 md:px-6">
        ...
        <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-4">
          {roles.map((role, index) => (
            <div
              key={index}
              className="flex flex-col h-full rounded-2xl bg-muted/50 border border-border p-6 transition-all hover:border-primary/20 hover:shadow-lg"
            >
              ...
              <h4 className="text-xl font-bold text-foreground mb-4">{role.headline}</h4>
              ...
              <blockquote className="mt-auto border-t border-border pt-4 text-sm italic text-muted-foreground">
                "{role.quote}"
                <footer className="mt-1 font-medium not-italic text-foreground">
                  — {role.author}
                </footer>
              </blockquote>
            </div>
