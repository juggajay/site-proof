  ...
  const problems = [
    {
      ...
      detail:
        'ITPs on clipboards, photos in camera rolls, test results in emails. Nobody can find anything.',
    },
    {
      icon: Clock,
      ...
      <div className="container mx-auto px-4 md:px-6">
        ...
        <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
          {problems.map((problem, index) => (
            <div
              key={index}
              className="flex flex-col items-start p-6 rounded-xl border bg-card shadow-sm hover:shadow-md transition-shadow"
            >
