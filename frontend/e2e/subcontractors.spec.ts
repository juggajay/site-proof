...
test.describe('Subcontractor portal module access', () => {
  ...
  test('uses the global notifications bell and does not render a duplicate settings bell', async ({
    page,
  }) => {
    await mockSubcontractorDashboardApi(page, [
      {
    ...
    // The header bell is the single global notifications entry point. It opens
    // a dropdown whose footer link is the only route to /notifications.
