...
- **Maximum-size claim** (5,000 members): decision succeeds inside its p95 < 3s budget (revised 2026-07-27 from 2s), all member rows present, compact-verdict size budget held `[R3-3]`.
